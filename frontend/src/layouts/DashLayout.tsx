...
const menuItems = [
...

  {
    ...
    icon: Users,
    submenu: [
      { title: "Device", icon: BarChart3, link: "/admin/devices" },
      { title: "Alert", link: "/admin/alerts" },
      { title: "Vaccin", link: "/admin/vaccins" },
      { title: "Message-alert", link: "/admin/message-alert" },
      
      { title: "Pays", link: "/admin/pays" },
      { title: "Ville", link: "/admin/ville" },
      { title: "Souche", link: "/admin/souche" },
